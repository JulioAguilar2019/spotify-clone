    ...
    return (
        ...
        <Container>
            <View className={'p-0 flex flex-row items-center bg-gray-50/40 border border-gray-300/20 rounded-lg mb-5 mx-3 mt-2 shadow-md'}>
                ...
                <TextInput onChangeText={(text: string) => { setSearch(text) }} onSubmitEditing={onSearchSubmit} className={'flex-auto p-3 pl-0'} numberOfLines={1} multiline={false} clearButtonMode="always" placeholderTextColor="white" placeholder='Buscar...' />
            </View>
